        ...
        <div className="flex-1 overflow-auto ml-0">
          ...
          <div className="min-h-screen mt-4 rounded-2xl bg-gray-50 p-2 sm:p-4 md:p-6">
            ...
            <p>
              ...
              ab explicabo nesciunt alias sapiente animi voluptates provident
              voluptate rerum sint iusto, vitae hic, numquam velit doloremque
              expedita similique eaque possimus.
            </p>
            {/* Mobile Header */}
