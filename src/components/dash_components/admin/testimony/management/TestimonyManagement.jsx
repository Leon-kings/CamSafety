...
const testimonialService = {
  ...
  deleteTestimonial: async (id) => {
    try {
      await axios.delete(`${API_URL}/api/testimonials/${id}`, { timeout: 5000 });
  ...
  return (
    <div className="min-h-screen mt-4 rounded-2xl bg-gray-50 p-2 sm:p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h3 className="text-2xl font-bold text-black">Testimonial Management</h3>
        ...
        <>
          ...
          <div className="sm:hidden space-y-4">
            {testimonials.length > 0 ? (
              ...
              <div className="text-center py-8 text-black">No testimonials found</div>
            )}
          </div>
          ...
          {totalPages > 1 && (
            <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="text-sm text-black">
                ...
                {Math.min(page * 100, totalTestimonials)} of {totalTestimonials}{" "}
                testimonials
              </div>
              <div className="flex gap-2">
                <button
