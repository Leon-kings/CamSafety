  ...
  return (
    <div className="min-h-screen mt-4 rounded-2xl bg-gray-50 p-2 sm:p-4 md:p-6">
      ...
      <div className="hidden sm:flex justify-between items-center mb-6">
        <h3 className="text-2xl font-bold text-black">Message Management</h3>
        <button
          onClick={() => openModal()}
              ...
              messages.map((message) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="font-medium text-black">{message.name}</h3>
                      <p className="text-sm text-black">{message.email}</p>
                      <p className="text-xs text-gray-600">{message.service}</p>
                    </div>
          ...
          {totalPages > 1 && (
            <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="text-sm text-black">
                Showing {(page - 1) * 10 + 1}-
                {Math.min(page * 10, messages.length)} of {totalPages * 10}{" "}
                messages
              </div>
              <div className="flex gap-2">
                <button
